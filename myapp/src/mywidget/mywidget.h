...
void my_widget_add(MyWidget* widget, GtkWidget* child);
void my_widget_remove(MyWidget* widget, GtkWidget* child);
void my_widget_set_name(MyWidget* widget, const gchar* name);
